"""
Django settings for classicelectricals project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'app.context_processors.categories_footer',
            ],
        },
    },
]

WSGI_APPLICATION = 'classicelectricals.wsgi.application'
...
#         'NAME': 'classic',   # exactly as shown on PythonAnywhere
#         'USER': 'root',             # exactly as shown
#         'PASSWORD': '',         # from PythonAnywhere database page
#         'HOST': 'localhost',  # shown on database page
